...
context.run_checkpoint(checkpoint_name="data_migration_posts_table_pre_validation_checkpoint")
context.run_checkpoint(checkpoint_name="data_migration_commerce_order_table_pre_validation_checkpoint")
