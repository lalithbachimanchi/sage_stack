...
csv_file_path = "/opt/data/sample_etl_data.csv"  # Replace with your CSV file path
...
df_formatted = df_with_age.withColumn("formatted_phone_number", format_phone_number(col("phone_number")))
...
df_formatted.write.jdbc(url=mysql_url, table=table_name, mode="overwrite", properties=mysql_properties)
